...
class Todos extends CI_Controller
{
    ...
    public function index()
    {
        ...
        //child view
        $data['cat_seleccionada'] = 'Todos los productos';
        ...
        $opciones['base_url'] = base_url()."frontend/todos/index/page/";
        ...
        $data['content_for_layout'] = $this->load->view('frontend/todos', $data, TRUE);
