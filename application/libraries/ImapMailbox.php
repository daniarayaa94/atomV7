...
class ImapMailbox {
    ...
    public function __construct() {
        $this->mailbox = "{imap.gmail.com:993/imap/ssl/novalidate-cert}";
        $this->imap = @imap_open($this->mailbox, 'dani.glover@gmail.com', '5539741') or die('Cannot connect to Gmail: ' . imap_last_error());
    }
