                ...
                <div class="col-xs-4">
                    ...
                    <div class="box">
                        ...
                        <div class="box box-solid">
                            <div class="box-header with-border" style="padding-bottom: 20px;padding-top: 15px;">

                                <h3 class="box-title" style="line-height: 25px;">Cotizaciones</h3>
                                <div class="pull-right box-tools" style="padding-top: 5px;">
                                    <form action="<?php echo $base_url?>" method="post" >

                                        <select name="inputEstados" class="form-control" style="height: 35px;" onchange="this.form.submit()">

                                            <option value="0" <?php echo ((0 == $estado) ? 'selected' : '' );?> >Todos</option>

                                            <?php foreach ($estados_list as $row){ ?>
                                                <option value="<?php echo $row['idEstado']; ?>" <?php echo (($row['idEstado'] == $estado) ? 'selected' : '' );?>><?php echo $row['nombre'].'s'; ?></option>
                                            <?php }?>
