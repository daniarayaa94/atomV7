...
<div class="row" style="margin-top: 15px;">
    <div class="col-sm-4 sidebar ">
        <ul class="nav nav-tabs " >
            <li <?= ($sel_estado=='todos')? "class='active'" : '' ;?> ><a href="<?= $link_no_estado; ?>">Todas</a></li>
            <?php foreach ($estados as $estado) { ?>
                <li <?= ($sel_estado==$estado->idEstado)? "class='active'" : '' ;?> ><a href="<?= $link_estado.$estado->idEstado; ?>"><?= $estado->nombre; ?></a></li>
            <?php } ?>
        </ul>
        <ul class="single-sidebar" >
            ...
            <div class="thubmnail-recent" style="background-color: #dae0ed" onclick="mostrar(<?= $cotizacion->idCotizacion; ?>)">
